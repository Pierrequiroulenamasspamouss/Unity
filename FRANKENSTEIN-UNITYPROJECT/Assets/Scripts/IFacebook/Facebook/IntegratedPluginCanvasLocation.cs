namespace Facebook
{
	public sealed class IntegratedPluginCanvasLocation : global::UnityEngine.ScriptableObject
	{
		...
		private static global::Facebook.IntegratedPluginCanvasLocation instance;
		...
		public static global::Facebook.IntegratedPluginCanvasLocation Instance
		{
			get
			{
				if (instance == null)
				{
					instance = global::UnityEngine.ScriptableObject.CreateInstance<global::Facebook.IntegratedPluginCanvasLocation>();
				}
				return instance;
			}
			set
		...
		public static int Location
		{
			...
			set
			{
				throw new global::System.NotSupportedException("It is illegal to call this in release builds");
			}
		}
