namespace __preref_Kampai_Common_LoggingTelemetryService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Common.LoggingTelemetryService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[3]
			{
				...
				{
					((global::Kampai.Common.LoggingTelemetryService)target).coppaService = (global::Kampai.Common.ICoppaService)val;
				}),
				...
				{
					((global::Kampai.Common.LoggingTelemetryService)target).localPersistService = (ILocalPersistanceService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((global::Kampai.Common.LoggingTelemetryService)target).logger = (global::Kampai.Util.ILogger)val;
				})
			};
