namespace __preref_Kampai_Util_CoroutineProgressMonitor
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Util.CoroutineProgressMonitor();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[2]
			{
				...
				{
					((global::Kampai.Util.CoroutineProgressMonitor)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Util.CoroutineProgressMonitor)target).updateRunner = (global::Kampai.Util.IUpdateRunner)val;
				})
			};
