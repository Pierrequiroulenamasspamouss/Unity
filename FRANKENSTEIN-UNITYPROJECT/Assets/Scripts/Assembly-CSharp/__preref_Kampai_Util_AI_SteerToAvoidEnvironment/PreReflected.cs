namespace __preref_Kampai_Util_AI_SteerToAvoidEnvironment
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Util.AI.SteerToAvoidEnvironment();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[1]
			{
				...
				{
					((global::Kampai.Util.AI.SteerToAvoidEnvironment)target).environment = (global::Kampai.Game.Environment)val;
				})
			};
