public class PlayGameServices
{
	...
	public static GPGPlayerInfo getLocalPlayerInfo()
	{
		...
		return global::Prime31.Json.decode<GPGPlayerInfo>(json);
	}
	...
	public static global::System.Collections.Generic.List<GPGAchievementMetadata> getAllAchievementMetadata()
	{
		if (global::UnityEngine.Application.platform != global::UnityEngine.RuntimePlatform.Android)
		{
			return new global::System.Collections.Generic.List<GPGAchievementMetadata>();
		}
		string json = _plugin.Call<string>("getAllAchievementMetadata", new object[0]);
		return global::Prime31.Json.decode<global::System.Collections.Generic.List<GPGAchievementMetadata>>(json);
	}
	...
	public static global::System.Collections.Generic.List<GPGLeaderboardMetadata> getAllLeaderboardMetadata()
	{
		if (global::UnityEngine.Application.platform != global::UnityEngine.RuntimePlatform.Android)
		{
			return new global::System.Collections.Generic.List<GPGLeaderboardMetadata>();
		}
		string json = _plugin.Call<string>("getAllLeaderboardMetadata", new object[0]);
		return global::Prime31.Json.decode<global::System.Collections.Generic.List<GPGLeaderboardMetadata>>(json);
	}
	...
	{
		if (global::UnityEngine.Application.platform == global::UnityEngine.RuntimePlatform.Android && steps > 0)
		{
