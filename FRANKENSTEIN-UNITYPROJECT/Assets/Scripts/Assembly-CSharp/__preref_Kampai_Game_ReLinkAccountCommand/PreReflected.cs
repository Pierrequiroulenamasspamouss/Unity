namespace __preref_Kampai_Game_ReLinkAccountCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.ReLinkAccountCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[12]
			{
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).socialService = (global::Kampai.Game.ISocialService)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).toUserId = (string)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(string), delegate(object target, object val)
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).ServerUrl = (string)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).downloadService = (global::Kampai.Download.IDownloadService)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).userSessionService = (global::Kampai.Game.IUserSessionService)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).LocalPersistService = (ILocalPersistanceService)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).encryptionService = (IEncryptionService)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).reloadGameSiganl = (global::Kampai.Main.ReloadGameSignal)val;
				}),
				...
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).socialEventService = (global::Kampai.Game.ITimedSocialEventService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((global::Kampai.Game.ReLinkAccountCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
			SetterNames = new object[12]
			{
				null, null, null, "game.server.host", null, null, null, null, null, null,
				null, null
			};
		}
	}
