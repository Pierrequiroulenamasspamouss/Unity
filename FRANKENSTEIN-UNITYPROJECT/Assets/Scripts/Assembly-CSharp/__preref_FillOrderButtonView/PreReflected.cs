namespace __preref_FillOrderButtonView
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new FillOrderButtonView();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[4]
			{
				...
				{
					((FillOrderButtonView)target).popupMessageSignal = (global::Kampai.UI.View.PopupMessageSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Main.ILocalizationService), delegate(object target, object val)
				{
					((FillOrderButtonView)target).localService = (global::Kampai.Main.ILocalizationService)val;
				}),
				...
				{
					((FillOrderButtonView)target).localPersistService = (ILocalPersistanceService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Main.PlayGlobalSoundFXSignal), delegate(object target, object val)
				{
					((FillOrderButtonView)target).playSFXSignal = (global::Kampai.Main.PlayGlobalSoundFXSignal)val;
				})
			};
