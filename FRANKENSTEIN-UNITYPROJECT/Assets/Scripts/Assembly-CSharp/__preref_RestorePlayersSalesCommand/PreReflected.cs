namespace __preref_RestorePlayersSalesCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new RestorePlayersSalesCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[9]
			{
				...
				{
					((RestorePlayersSalesCommand)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IPlayerService), delegate(object target, object val)
				{
					((RestorePlayersSalesCommand)target).playerService = (global::Kampai.Game.IPlayerService)val;
				}),
				...
				{
					((RestorePlayersSalesCommand)target).timeEventService = (global::Kampai.Game.ITimeEventService)val;
				}),
				...
				{
					((RestorePlayersSalesCommand)target).timeService = (global::Kampai.Game.ITimeService)val;
				}),
				...
				{
					((RestorePlayersSalesCommand)target).marketplaceItemSoldSignal = (global::Kampai.Game.MarketplaceItemSoldSignal)val;
				}),
				...
				{
					((RestorePlayersSalesCommand)target).marketplaceService = (global::Kampai.Game.IMarketplaceService)val;
				}),
				...
				{
					((RestorePlayersSalesCommand)target).updateSoldItemsSignal = (global::Kampai.Game.MarketplaceUpdateSoldItemsSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((RestorePlayersSalesCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((RestorePlayersSalesCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
