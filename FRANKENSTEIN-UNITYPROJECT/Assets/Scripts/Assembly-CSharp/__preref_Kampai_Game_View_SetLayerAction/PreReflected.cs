namespace __preref_Kampai_Game_View_SetLayerAction
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.View.SetLayerAction((global::Kampai.Game.View.ActionableObject)p[0], (int)p[1], (global::Kampai.Util.ILogger)p[2], (int)p[3]);
