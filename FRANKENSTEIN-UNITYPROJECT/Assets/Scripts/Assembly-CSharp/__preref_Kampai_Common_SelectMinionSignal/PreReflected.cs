namespace __preref_Kampai_Common_SelectMinionSignal
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Common.SelectMinionSignal();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[1]
			{
				...
				{
					((global::Kampai.Common.SelectMinionSignal)target).kernel = (global::Kampai.Game.QuestScriptKernel)val;
				})
			};
