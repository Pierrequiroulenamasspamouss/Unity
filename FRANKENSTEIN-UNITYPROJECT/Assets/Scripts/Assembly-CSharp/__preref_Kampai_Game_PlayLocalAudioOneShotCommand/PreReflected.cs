namespace __preref_Kampai_Game_PlayLocalAudioOneShotCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.PlayLocalAudioOneShotCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[1]
			{
				...
				{
					((global::Kampai.Game.PlayLocalAudioOneShotCommand)target).fmodService = (global::Kampai.Common.Service.Audio.IFMODService)val;
				})
			};
