namespace __preref_Kampai_Game_DCNService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.DCNService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[4]
			{
				...
				{
					((global::Kampai.Game.DCNService)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Game.DCNService)target).coppaService = (global::Kampai.Common.ICoppaService)val;
				}),
				...
				{
					((global::Kampai.Game.DCNService)target).downloadService = (global::Kampai.Download.IDownloadService)val;
				}),
				...
				{
					((global::Kampai.Game.DCNService)target).dcnTokenSignal = (global::Kampai.Game.DCNTokenSignal)val;
				})
			};
