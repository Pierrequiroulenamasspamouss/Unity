namespace __preref_Kampai_Game_FacebookService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.FacebookService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[4]
			{
				...
				{
					((global::Kampai.Game.FacebookService)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Game.FacebookService)target).localPersistence = (ILocalPersistanceService)val;
				}),
				...
				{
					((global::Kampai.Game.FacebookService)target).telemetryService = (global::Kampai.Common.ITelemetryService)val;
				}),
				...
				{
					((global::Kampai.Game.FacebookService)target).configurationsService = (global::Kampai.Game.IConfigurationsService)val;
				})
			};
