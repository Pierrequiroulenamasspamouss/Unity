namespace Kampai.Game
{
	public class DefinitionService : global::Kampai.Game.IDefinitionService
	{
        ...
        {
            // LE FIX EST ICI : On v�rifie si la d�finition existe avant de toucher � ses sous-�l�ments
            ...
            // S�curit�s suppl�mentaires au cas o� les sous-listes seraient nulles aussi
