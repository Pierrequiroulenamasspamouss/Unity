namespace __preref_Kampai_Game_OrderBoardService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.OrderBoardService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[7]
			{
				...
				{
					((global::Kampai.Game.OrderBoardService)target).definitionService = (global::Kampai.Game.IDefinitionService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IPlayerService), delegate(object target, object val)
				{
					((global::Kampai.Game.OrderBoardService)target).playerService = (global::Kampai.Game.IPlayerService)val;
				}),
				...
				{
					((global::Kampai.Game.OrderBoardService)target).randomService = (global::Kampai.Common.IRandomService)val;
				}),
				...
				{
					((global::Kampai.Game.OrderBoardService)target).characterService = (global::Kampai.Game.IPrestigeService)val;
				}),
				...
				{
					((global::Kampai.Game.OrderBoardService)target).showDialogSignal = (global::Kampai.Game.ShowDialogSignal)val;
				}),
				...
				{
					((global::Kampai.Game.OrderBoardService)target).updateTicketOnBoardSignal = (global::Kampai.Game.OrderBoardUpdateTicketOnBoardSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((global::Kampai.Game.OrderBoardService)target).logger = (global::Kampai.Util.ILogger)val;
				})
			};
