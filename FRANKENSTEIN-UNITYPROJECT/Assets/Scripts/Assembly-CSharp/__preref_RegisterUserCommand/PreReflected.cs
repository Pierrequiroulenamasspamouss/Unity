namespace __preref_RegisterUserCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new RegisterUserCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[7]
			{
				...
				{
					((RegisterUserCommand)target).ServerUrl = (string)val;
				}),
				...
				{
					((RegisterUserCommand)target).DownloadService = (global::Kampai.Download.IDownloadService)val;
				}),
				...
				{
					((RegisterUserCommand)target).UserSessionService = (global::Kampai.Game.IUserSessionService)val;
				}),
				...
				{
					((RegisterUserCommand)target).synergyService = (global::Kampai.Game.ISynergyService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((RegisterUserCommand)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((RegisterUserCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((RegisterUserCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
			SetterNames = new object[7] { "game.server.host", null, null, null, null, null, null };
		}
	}
}
