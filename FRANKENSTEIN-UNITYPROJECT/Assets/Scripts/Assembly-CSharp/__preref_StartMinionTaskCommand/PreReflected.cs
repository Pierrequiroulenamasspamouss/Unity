namespace __preref_StartMinionTaskCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new StartMinionTaskCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[20]
			{
				...
				{
					((StartMinionTaskCommand)target).parameters = (global::Kampai.Util.Tuple<int, int, int>)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IPlayerService), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).playerService = (global::Kampai.Game.IPlayerService)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).startMinionRouteSignal = (global::Kampai.Game.StartMinionRouteSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::UnityEngine.GameObject), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).minionManager = (global::UnityEngine.GameObject)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::UnityEngine.GameObject), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).buildingManager = (global::UnityEngine.GameObject)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).pathFinder = (global::Kampai.Util.PathFinder)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).questService = (global::Kampai.Game.IQuestService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Common.AddMinionToEventServiceSignal), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).addMinionSignal = (global::Kampai.Common.AddMinionToEventServiceSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).timeService = (global::Kampai.Game.ITimeService)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).timeEventService = (global::Kampai.Game.ITimeEventService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IDefinitionService), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).definitionService = (global::Kampai.Game.IDefinitionService)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).characterService = (global::Kampai.Game.IPrestigeService)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).minionStateChangeSignal = (global::Kampai.Game.MinionStateChangeSignal)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).changeState = (global::Kampai.Game.BuildingChangeStateSignal)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).teleportMinionToBuildingSignal = (global::Kampai.Game.TeleportMinionToBuildingSignal)val;
				}),
				...
				{
					((StartMinionTaskCommand)target).killFunWithMinionStateSignal = (global::Kampai.Game.KillFunWithMinionStateSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.IRoutineRunner), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).routineRunner = (global::Kampai.Util.IRoutineRunner)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((StartMinionTaskCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
