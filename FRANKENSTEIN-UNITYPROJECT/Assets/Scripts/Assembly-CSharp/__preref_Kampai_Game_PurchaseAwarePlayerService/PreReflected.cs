namespace __preref_Kampai_Game_PurchaseAwarePlayerService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.PurchaseAwarePlayerService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[12]
			{
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IDefinitionService), delegate(object target, object val)
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).definitionService = (global::Kampai.Game.IDefinitionService)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).randService = (global::Kampai.Common.IRandomService)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).timeService = (global::Kampai.Game.ITimeService)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).postTransactionSignal = (global::Kampai.Game.PostTransactionSignal)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).insufficientInputsSignal = (global::Kampai.Game.InsufficientInputsSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.UI.View.DisplayRandomDropIconSignal), delegate(object target, object val)
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).randomDropSignal = (global::Kampai.UI.View.DisplayRandomDropIconSignal)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).openStorageBuildingSignal = (global::Kampai.Game.OpenStorageBuildingSignal)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).changeState = (global::Kampai.Game.BuildingChangeStateSignal)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).telemetryService = (global::Kampai.Common.ITelemetryService)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).localPersistanceService = (ILocalPersistanceService)val;
				}),
				...
				{
					((global::Kampai.Game.PurchaseAwarePlayerService)target).ShowBuildingDetailmenuSignal = (global::Kampai.UI.View.ShowBuildingDetailMenuSignal)val;
				})
			};
