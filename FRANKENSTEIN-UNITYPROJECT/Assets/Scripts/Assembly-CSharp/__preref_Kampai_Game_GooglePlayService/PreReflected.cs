namespace __preref_Kampai_Game_GooglePlayService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.GooglePlayService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[4]
			{
				...
				{
					((global::Kampai.Game.GooglePlayService)target).localPersistence = (ILocalPersistanceService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((global::Kampai.Game.GooglePlayService)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Game.GooglePlayService)target).telemetryService = (global::Kampai.Common.ITelemetryService)val;
				}),
				...
				{
					((global::Kampai.Game.GooglePlayService)target).configurationsService = (global::Kampai.Game.IConfigurationsService)val;
				})
			};
