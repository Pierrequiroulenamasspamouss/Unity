namespace __preref_RestoreMinionStateCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new RestoreMinionStateCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[13]
			{
				...
				{
					((RestoreMinionStateCommand)target).minionID = (int)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IPlayerService), delegate(object target, object val)
				{
					((RestoreMinionStateCommand)target).playerService = (global::Kampai.Game.IPlayerService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IDefinitionService), delegate(object target, object val)
				{
					((RestoreMinionStateCommand)target).definitionService = (global::Kampai.Game.IDefinitionService)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).timeEventService = (global::Kampai.Game.ITimeEventService)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).timeService = (global::Kampai.Game.ITimeService)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).taskCompleteSignal = (global::Kampai.Common.MinionTaskCompleteSignal)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).teleportTaskSignal = (global::Kampai.Game.StartTeleportTaskSignal)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).enableRendererSignal = (global::Kampai.Game.EnableMinionRendererSignal)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).restoreMinionAtTikiBarSignal = (global::Kampai.Game.RestoreMinionAtTikiBarSignal)val;
				}),
				...
				{
					((RestoreMinionStateCommand)target).teleportMinionToLeisureSignal = (global::Kampai.Game.TeleportMinionToLeisureSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Util.ILogger), delegate(object target, object val)
				{
					((RestoreMinionStateCommand)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((RestoreMinionStateCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((RestoreMinionStateCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
