namespace __preref_Kampai_Game_PostTransactionSignal
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.PostTransactionSignal();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[1]
			{
				...
				{
					((global::Kampai.Game.PostTransactionSignal)target).kernel = (global::Kampai.Game.QuestScriptKernel)val;
				})
			};
