namespace __preref_Kampai_Common_CoppaService
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Common.CoppaService();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[2]
			{
				...
				{
					((global::Kampai.Common.CoppaService)target).logger = (global::Kampai.Util.ILogger)val;
				}),
				...
				{
					((global::Kampai.Common.CoppaService)target).localPersistanceService = (ILocalPersistanceService)val;
				})
			};
