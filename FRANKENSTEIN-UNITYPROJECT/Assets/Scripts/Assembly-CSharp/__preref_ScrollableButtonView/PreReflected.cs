namespace __preref_ScrollableButtonView
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new ScrollableButtonView();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[3]
			{
				...
				{
					((ScrollableButtonView)target).popupMessageSignal = (global::Kampai.UI.View.PopupMessageSignal)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Main.ILocalizationService), delegate(object target, object val)
				{
					((ScrollableButtonView)target).localService = (global::Kampai.Main.ILocalizationService)val;
				}),
				...
				{
					((ScrollableButtonView)target).localPersistService = (ILocalPersistanceService)val;
				})
			};
