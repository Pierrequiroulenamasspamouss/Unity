namespace __preref_Kampai_Game_View_PhilView
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.View.PhilView();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[2]
			{
				...
				{
					((global::Kampai.Game.View.PhilView)target).randomService = (global::Kampai.Common.IRandomService)val;
				}),
				...
				{
					((global::Kampai.Game.View.PhilView)target).fmodService = (global::Kampai.Common.Service.Audio.IFMODService)val;
				})
			};
