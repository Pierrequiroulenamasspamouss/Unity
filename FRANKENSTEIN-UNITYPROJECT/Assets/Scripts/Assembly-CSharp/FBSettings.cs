public class FBSettings : global::UnityEngine.ScriptableObject
{
	...
	private static FBSettings Instance
	{
		get
		{
			if (instance == null)
			{
				instance = global::UnityEngine.Resources.Load("FacebookSettings") as FBSettings;
				if (instance == null)
				{
					instance = global::UnityEngine.ScriptableObject.CreateInstance<FBSettings>();
				}
			}
			return instance;
		}
