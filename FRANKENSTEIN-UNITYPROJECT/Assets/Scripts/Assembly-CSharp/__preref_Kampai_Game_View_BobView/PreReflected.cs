namespace __preref_Kampai_Game_View_BobView
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new global::Kampai.Game.View.BobView();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[2]
			{
				...
				{
					((global::Kampai.Game.View.BobView)target).randomService = (global::Kampai.Common.IRandomService)val;
				}),
				...
				{
					((global::Kampai.Game.View.BobView)target).fmodService = (global::Kampai.Common.Service.Audio.IFMODService)val;
				})
			};
