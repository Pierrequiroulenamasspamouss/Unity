namespace __preref_StartConstructionCommand
{
	internal sealed class PreReflected : global::strange.extensions.reflector.impl.ReflectedClass
	{
		...
		{
			PreGenerated = true;
			Constructor = (object[] p) => new StartConstructionCommand();
			...
			Setters = new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>[12]
			{
				...
				{
					((StartConstructionCommand)target).buildingObj = (global::UnityEngine.GameObject)val;
				}),
				...
				{
					((StartConstructionCommand)target).buildingId = (int)val;
				}),
				...
				{
					((StartConstructionCommand)target).restoreTimer = (bool)val;
				}),
				...
				{
					((StartConstructionCommand)target).constructionCompleteSignal = (global::Kampai.Game.ConstructionCompleteSignal)val;
				}),
				...
				{
					((StartConstructionCommand)target).buildingChangeStateSignal = (global::Kampai.Game.BuildingChangeStateSignal)val;
				}),
				...
				{
					((StartConstructionCommand)target).worldProgressSignal = (global::Kampai.UI.View.DisplayWorldProgressSignal)val;
				}),
				...
				{
					((StartConstructionCommand)target).timeEventService = (global::Kampai.Game.ITimeEventService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::Kampai.Game.IPlayerService), delegate(object target, object val)
				{
					((StartConstructionCommand)target).playerService = (global::Kampai.Game.IPlayerService)val;
				}),
				...
				{
					((StartConstructionCommand)target).timeService = (global::Kampai.Game.ITimeService)val;
				}),
				...
				{
					((StartConstructionCommand)target).questService = (global::Kampai.Game.IQuestService)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.command.api.ICommandBinder), delegate(object target, object val)
				{
					((StartConstructionCommand)target).commandBinder = (global::strange.extensions.command.api.ICommandBinder)val;
				}),
				new global::System.Collections.Generic.KeyValuePair<global::System.Type, global::System.Action<object, object>>(typeof(global::strange.extensions.injector.api.IInjectionBinder), delegate(object target, object val)
				{
					((StartConstructionCommand)target).injectionBinder = (global::strange.extensions.injector.api.IInjectionBinder)val;
				})
			};
