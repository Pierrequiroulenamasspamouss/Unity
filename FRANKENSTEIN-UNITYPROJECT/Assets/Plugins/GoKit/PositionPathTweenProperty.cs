public class PositionPathTweenProperty : AbstractTweenProperty
{
	...
	public override void tick(float totalElapsedTime)
	{
		...
		case GoLookAtType.NextPathNode:
			_smoothedRotation.smoothValue = ((!(pointOnPath == _target.position)) ? global::UnityEngine.Quaternion.LookRotation(pointOnPath - _target.position) : global::UnityEngine.Quaternion.identity);
