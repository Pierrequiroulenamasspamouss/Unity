namespace FMOD
{
	public class Error
	{
		public static string String(global::FMOD.RESULT errcode)
		{
			switch (errcode)
			{
			case global::FMOD.RESULT.OK:
				return "No errors.";
			case global::FMOD.RESULT.ERR_BADCOMMAND:
			...
			case global::FMOD.RESULT.ERR_DSP_DONTPROCESS:
			...
			case global::FMOD.RESULT.ERR_DSP_FORMAT:
			...
			case global::FMOD.RESULT.ERR_OUTPUT_FORMAT:
				return "Soundcard does not support the specified format.";
			case global::FMOD.RESULT.ERR_OUTPUT_INIT:
				return "Error initializing output device.";
			case global::FMOD.RESULT.ERR_OUTPUT_NODRIVERS:
			...
			case global::FMOD.RESULT.ERR_SUBSOUNDS:
			...
			case global::FMOD.RESULT.ERR_SUBSOUND_ALLOCATED:
			...
			case global::FMOD.RESULT.ERR_SUBSOUND_CANTMOVE:
			...
			case global::FMOD.RESULT.ERR_TAGNOTFOUND:
				return "The specified tag could not be found or there are no tags.";
			case global::FMOD.RESULT.ERR_TOOMANYCHANNELS:
